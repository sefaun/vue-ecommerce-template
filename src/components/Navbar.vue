      ...
      <div class="container">
        <div class="containt_main">
          <div id="mySidenav" class="sidenav">
            ...
            <a @click="$router.push('/fashion')">Fashion</a>
            <a @click="$router.push('/electronic')">Electronic</a>
            <a @click="$router.push('/jewellery')">Jewellery</a>
          </div>
          <span class="toggle_icon" @click="openNav()"><img src="images/toggle-icon.png" /></span>
          <div class="dropdown">
